...
def gen_and_sp(ins, h):
    ...
    for br in range(0, ins):
        sys.stdout.write("PM_PU" + str(id_gen()) + " (w_out" + " I" + str(br) + " VDD VDD) " + str(pmos) + " w=" + str(pm_sw * h) + "n l=" + str(ms_sl) + "n \n")
        #sys.stdout.write("PM_PU" + str(br) + " OUT I" + str(br) + " VDD VDD " + str(pmos) + " w=" + str(pm_sw * h) + "n l=" + str(ms_sl) + "n \n")

    sys.stdout.write("NM_PD" + str(id_gen()) + " (w_out" + " I0" + " w_o_0" + " GND) " + str(nmos) + " w=" + str(nm_sw * h) + "n l=" + str(ms_sl) + "n \n")
    ...
    sys.stdout.write("PM_INV" + str(id_gen()) + " (OUT" + " w_out" + " VDD" + " VDD) " + str(pmos) + " w=" + str(int(pm_sw) * h * 4) + "n l=" + str(ms_sl) + "n \n")
    sys.stdout.write("NM_INV" + str(id_gen()) + " (OUT" + " w_out" + " GND" + " GND) " + str(nmos) + " w=" + str(int(nm_sw) * h * 4) + "n l=" + str(ms_sl) + "n \n")

    sys.stdout.write("ends STDAND" + str(ins) + "_" + str(h) + "X \n\n")
